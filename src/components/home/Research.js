...
const Projects = [
  {
    heading:"Prototype Development of Artificial Intelligence based Portable Computer Aided Diagnosis System for Silicosis [Apr-2022]",
    text:"Directorate of Specially abled People , Govt. of Rajasthan, Cost (Lacs):22.59 PI: Dr. Kuldeep Singh, Deptt. of Electronics & Communication Engineering",
  },
  {
    heading:"Prototype Development of Artificial Intelligence based Portable Computer Aided Diagnosis System for Silicosis [Apr-2022]",
    text:"Directorate of Specially abled People , Govt. of Rajasthan, Cost (Lacs):22.59 PI: Dr. Kuldeep Singh, Deptt. of Electronics & Communication Engineering",
    ...
    <div className={classes.main}>
      ...
      <div className={classes.container}>
        <div className={classes.research}>
          ...
          <marquee behaviour = "scroll" direction = "up" className={classes.researchSection}>
            {
